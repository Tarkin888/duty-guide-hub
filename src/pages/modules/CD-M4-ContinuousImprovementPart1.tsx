...
export default function CDM4ContinuousImprovementPart1() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-start justify-between flex-wrap gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-foreground">CD-M4A: Continuous Improvement Framework</h1>
      ...
      <ModuleInsights moduleCode="CD-M4A" moduleTitle="Continuous Improvement Part 1" />
    </div>
  );
}
